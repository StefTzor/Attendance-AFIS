 ...
 */
public class AFISTest extends javax.swing.JFrame {
                ...
                SwingUtilities.invokeLater(new Runnable(){
                    public void run(){
                        ...
                        try{
                            ...
                            Logger.getLogger(AFISTest.class.getName()).log(Level.SEVERE, null, ex);
                        }finally{
            ...
            try{
                ...
                switch(Enrollment.getTemplateStatus()){
                    ...
                    case TEMPLATE_STATUS_FAILED: // If failed restart fingerprint capture
                        ...
                        stop();
                        setTemplate(null);
                        JOptionPane.showMessageDialog(AFISTest.this, "The fingerprint cannot been created", "Attendance Tracker", JOptionPane.ERROR_MESSAGE);
                        start();
                    break;
                }
            }
    ...
    public void attachImage(){
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                DispImage.setIcon(new ImageIcon(img));
            } catch (IOException ex) {
    ...
    private void initComponents() {
        ...
        DispImage = new javax.swing.JLabel();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(DispImage, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(lblFingerprintImage, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnAttach, javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(DispImage, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AFISTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AFISTest().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel DispImage;
